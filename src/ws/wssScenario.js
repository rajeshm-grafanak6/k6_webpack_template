...
export function webserviceTest() {
  let url = `wss://${globalThis.HOST}/ws/crocochat/${chatRoomName}/`;
  ...
  let res = ws.connect(url, params, function (socket) {
    socket.on('open', function open() {
      ...
      }, randomIntBetween(globalThis.PAUSE_MIN, globalThis.PAUSE_MAX)); // say something every 2-8seconds
    });
